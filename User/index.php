  ...
  <body style="background-color:dark;">
    ...
    <div class="container-fluid">
      ...
      <li><a href="index.php?page=update_profile"><span class="glyphicon glyphicon-user"></span> MY PROFILE</a></li>
       ...
       <li><a href="index.php?page=hostel_booking"><span class="glyphicon glyphicon-envelope"></span> APPLY_FOR_JOB</a></li>
       <li><a href="index.php?page=room-details"><span class="glyphicon glyphicon-envelope"></span>JOB_DETAILS</a></li>
